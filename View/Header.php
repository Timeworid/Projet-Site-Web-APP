    ...
    <header class="headerglobal .jeanneoskour">
        <div class= "menugauche">
                ...
                <div class="menu-content">
                    <a href="../routeur.php?action=PageProduit">Fiche Produit</a>
                ...
                <a href="../routeur.php?action=pageaccueil"><img src="../Data/logo.png" alt="menu" style="width:80px;height:40px;"></a>
                </div>
            </a>
        </div>
