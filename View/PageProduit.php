...
<div class="header2">
    ...
    <div class="parallax2">
        <div class="texteparallax">
            <span class="contourtexteparallax" style="background-color:transparent;font-size:25px;color: #f7f7f7;">100% MADE IN FRANCE</span>
        </div>
    </div>
    ...
    <div class="parallax3">
        <div class="texteparallax">
            <span class="contourtexteparallax" style="background-color:transparent;font-size:25px;color: #f7f7f7;">DECOUVREZ NOTRE PRODUIT ICI</span>
        </div>
    </div>
